...
async def create_embeddings(request: EmbeddingRequest):
    ...
    try:
        ...
        if isinstance(inputs, str):
            validate_text_content(inputs, max_length=10000)  # Reasonable limit for embedding input
...
async def list_models() -> Dict[str, Any]:
    ...
    models = [{"id": model, "object": "model", "owned_by": "local"} for model in settings.EMBED_MODELS]
    models.append({"id": settings.DEFAULT_OLLAMA_MODEL, "object": "model", "owned_by": "local"})
