...
# Add the parent directory to the path to access ghostwire modules
...
class OperatorConsoleClient:
    ...
    async def chat_with_embedding(self, text: str, session_id: str = None) -> str:
        ...
        embedding_response = await self.client.post(
            ...
            json={"input": text, "model": "nomic-embed-text"}  # Use appropriate embedding model
        )
    ...
    async def query_similar_memories(self, query: str, session_id: str = None, top_k: int = 5) -> Dict[str, Any]:
