...
class TestLoggingConfiguration:
    ...
    def test_setup_logging_with_env_vars(self):
        ...
        with patch.dict(
            os.environ,
            {"LOG_FORMAT": "json", "LOG_LEVEL": "DEBUG", "GHOSTWIRE_NO_EMOJI": "true"},
        ):
    ...
    def test_logging_to_file(self):
        ...
        try:
            with patch.dict(
                os.environ,
                {"LOG_FILE": tmp_filename, "LOG_LEVEL": "INFO", "LOG_FORMAT": "plain"},
            ):
                ...
                formatter = GhostWireFormatter(
                    log_format=LogFormat.PLAIN, use_emoji=False
                )
                record = logging.LogRecord(
                    name="test",
                    level=logging.INFO,
