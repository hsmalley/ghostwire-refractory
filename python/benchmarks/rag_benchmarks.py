...
class RAGBenchmark:
    ...
    async def run_rag_benchmark(self):
        ...
        avg_retrieval_lat, _, retrieval_memory, retrieval_quality, consistency = await self.test_retrieval_only(
        ...
        avg_rag_lat, _, rag_memory, rag_quality, hallucination_rate = await self.test_rag_query(
            session_id, test_queries[0], iterations=3
        )
